...
<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
    <div class="nano">
        <div class="nano-content">
            <div class="logo"><a href="/admin/default"><img src="/admin/includes/assets/images/logo.png" width="50px" height="50px"
                                                      alt=""/>
            ...
            <ul>
                ...
                if ($_SESSION['type_id'] == UsersTypes::TYPE_ADMIN) { ?>
                    <li><a class="sidebar-sub-toggle"><i class="ti-user"></i> Users <span
                        ...
                        <ul>
                            ...
                            <li><a href="/admin/user">Liste Users</a></li>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-files"></i> News <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="/admin/news">Liste News</a></li>
                ...
                if ($_SESSION['type_id'] == UsersTypes::TYPE_ADMIN) { ?>
                    <li><a class="sidebar-sub-toggle"><i class="ti-target"></i> Types <span
                                    class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="/admin/type">Liste Types</a></li>
                            <li><a href="/admin/type/add">Add Type</a></li>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-image"></i> Images <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="/admin/image">Liste Images</a></li>
                        <li><a href="/admin/image/add">Add Image</a></li>
                    </ul>
                </li>

                <li><a href="/admin/logout"><i class="ti-close"></i> Logout</a></li>
            </ul>
        </div>
    </div>
</div>
