...
class Profile
{
    ...
    public function getTable(): string
    {
        ...
        $profileImagePath = Helper::getImage($profileUserData->getImageId(),Helper::IMG_DIR_PROFILES . $profileUserData->getUserId());
...
<div class="container">
    <div class="row">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="form-valide" name="profileForm" method="POST" action="/admin/profile/' . $action['action'] . '" onsubmit="return validateEmail()">
                            Profile Image Management: <a href="/admin/image_profile/add/' . $profileUserData->getUserId() . '"><button type="button" class="btn btn-primary btn-sm btn-addon m-b-5 m-l-5"><i class="ti-plus"></i>Management</button></a>
                            <br>       
        ...
        $return .= '         
                            ...
                            <a class="btn btn-default btn-flat btn-addon m-b-10 m-l-5" href="/admin/profile">
